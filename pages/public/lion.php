...
<body class="bg-light text-dark font-sans">
  ...
  <header class="fixed top-0 w-full z-50 bg-dark/90 backdrop-blur-md border-b border-white/10">
    <div class="max-w-7xl mx-auto flex justify-between items-center px-6 py-4 text-white">
        ...
        <nav class="hidden md:flex gap-8 font-medium">
            ...
            <a href="animals.php" class="hover:text-accent transition">Animaux</a>
            <a href="visits.php" class="hover:text-accent transition">Visites Guidées</a>
            <a href="lion.php" class="hover:text-accent transition">Lion de l'Atlas</a>
        </nav>
  ...
  <!-- HERO SECTION -->
  <section class="relative h-screen parallax-bg" style="background-image: url('../../assets/images/lion-male-roar.avif');">
    ...
    <div class="relative z-10 h-full flex items-center justify-center text-center">
      <div class="max-w-4xl mx-auto px-6 space-y-6 animate-fade-in-up">
        ...
        <div>
          <img src="../../assets/images/Symbole-can_maroc.png"
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center pt-8">
          <a href="#histoire" class="bg-accent hover:bg-accent/90 text-dark px-8 py-4 rounded-full font-bold transition-all hover:scale-105 shadow-lg">
            Découvrir son histoire
          </a>
          <a href="#conservation" class="bg-white/10 backdrop-blur-sm border-2 border-white hover:bg-white/20 text-white px-8 py-4 rounded-full font-bold transition-all">
      ...
      <div class="grid lg:grid-cols-2 gap-12 items-center">
        <div class="space-y-6">
          ...
          <div class="bg-gradient-to-br from-primary/5 to-secondary/5 border-l-4 border-accent p-8 rounded-2xl">
            ...
            <p class="text-gray-700 leading-relaxed">
              Reconnaissable à sa crinière exceptionnellement épaisse, longue et sombre, s'étendant parfois jusqu'au ventre. 
        ...
        <div class="relative">
          <div class="absolute inset-0 bg-gradient-to-br from-accent/20 to-primary/20 rounded-3xl transform rotate-3"></div>
          <img src="../../assets/images/lion-male-roar.avif" alt="Lion de l'Atlas" class="relative rounded-3xl shadow-2xl w-full h-[600px] object-cover">
        </div>
      </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto text-center">
          ...
          <div class="grid md:grid-cols-3 gap-6 mt-12">
            <div class="bg-white rounded-2xl p-6 shadow-lg">
              <div class="text-3xl mb-3"><img src="../../assets/images/vibrant-traditional.png" class="h-16e w-16e"></div>
              <h4 class="font-bold text-primary mb-2">Conservation génétique</h4>
              <p class="text-sm text-gray-600">Préservation de la lignée</p>
            </div>
            <div class="bg-white rounded-2xl p-6 shadow-lg">
              <div class="text-3xl mb-3"><img src="../../assets/images/png-clipart-education-logo-pre-school-others-text-logo-thumbnail.png" class="h-16e w-16e"></div>
...
<section class="relative mb-24">
  <div class="bg-gradient-to-br from-primary via-secondary to-accent rounded-[2.5rem] p-16 md:p-20 text-white shadow-2xl overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto text-center">
      ...
      <div class="flex flex-wrap justify-center gap-4">
        <span class="px-6 py-3 rounded-full bg-white/20 backdrop-blur-md font-semibold hover:bg-white/30 transition">
          Fierté
        </span>
        <span class="px-6 py-3 rounded-full bg-white/20 backdrop-blur-md font-semibold hover:bg-white/30 transition">
          Résilience
