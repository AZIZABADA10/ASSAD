...
<!-- ================= MODAL AJOUT ================= -->
<div id="ajouter-visite-modal"
class="hidden fixed inset-0 bg-dark/90 flex justify-center items-center z-50">
...
<input type="text" name="titre" placeholder="Titre" required class="w-full px-4 py-2 rounded bg-transparent border">

<textarea name="description" required
placeholder="Description de la visite (contenu, thèmes, animaux, etc.)"
...
<input type="number" name="duree" placeholder="Durée (h)" required class="w-full px-4 py-2 rounded bg-transparent border">
<input type="number" name="prix" placeholder="Prix (MAD)" required class="w-full px-4 py-2 rounded bg-transparent border">
<input type="text" name="langue" placeholder="Langue" required class="w-full px-4 py-2 rounded bg-transparent border">
<input type="number" name="capacite_max" placeholder="Capacité max" required class="w-full px-4 py-2 rounded bg-transparent border">

<button type="submit" name="ajouter_visite"
class="w-full bg-red-700 py-2 rounded font-semibold">
Ajouter
</button>
